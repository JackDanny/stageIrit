...
const char* transparency_window = "transparence  GAFD+BRIEF+BF";
const char* matches_window = " GAFD+BRIEF+BF";
...
{
 Ptr<AdjusterAdapter> adjuster = new FastAdjuster(50);
  //Ptr<AdjusterAdapter> adjuster = new AdjusterAdapter("ORB");
  Ptr<FeatureDetector> detector =  new DynamicAdaptedFeatureDetector(adjuster,0,100);
