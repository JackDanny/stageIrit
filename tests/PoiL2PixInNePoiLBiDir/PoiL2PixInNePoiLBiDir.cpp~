...
int main(int argc, char **argv)
{
	...
	*/ 
    ...
    Mat descriptorAuxKp1;
     ...
     ///descriptor to the pixels of image2 in the neighborhood of the keypoint described by descriptorAuxKp1
    Mat descriptorNe;
     

     ///vector of pixels of image2 in the neighborhood of the keypoint described by descriptorAuxKp1   
...
///descriptor auxiliary for one point of pointsy. It's a strategy for use the matcher
