...
int gridCols=4)
 ...
 //Ptr<FeatureDetector> detectormser;

  

 // GridAdaptedFeatureDetector detector(detectormser);
...
int main( int, char** argv )
{
  ...
  Ptr<FeatureDetector> detector =  new GridAdaptedFeatureDetector(FeatureDetector::create("ORB"), 1000);
